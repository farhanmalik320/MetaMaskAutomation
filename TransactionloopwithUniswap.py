...
def uniswap():
    ...
    # get user balance
    user_balance = driver.find_element(By.CLASS_NAME, 'currency-display-component__text').text
    ...
    # add the amount in the First amount field
        ...
        driver.find_element(By.CLASS_NAME, 'token-amount-input').send_keys(n)
    ...
    # click on the WEth
        WebDriverWait(driver, 60).until(
            EC.element_to_be_clickable((By.CSS_SELECTOR, '.css-vurnku')))
    ...
    # click on add token
        ...
        WebDriverWait(driver, 60).until(
            EC.element_to_be_clickable((By.CSS_SELECTOR, '.css-15xhfkc')))

        close_btn = driver.find_element(By.CSS_SELECTOR, '.css-15xhfkc').click()
