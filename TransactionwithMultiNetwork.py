...
def transferfunds():
    ...
    WebDriverWait(driver, 60).until(EC.visibility_of_element_located((By.CSS_SELECTOR, '.currency-display-component__suffix')))
    time.sleep(1)
    currency = driver.find_element(By.CSS_SELECTOR, '.currency-display-component__suffix').text
    print(currency)

    time.sleep(5)
    # select the send button
    driver.get('chrome-extension://nkbihfbeogaeaoehlefnkodbefgpgknn/home.html#asset/' + currency)
